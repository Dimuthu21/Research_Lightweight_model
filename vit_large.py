...
# Load dataset
data_dir = "Potato Leaf Disease Dataset in Uncontrolled Environment"  # Update to your local path
try:
...
# Modify classifier (ViT's head) with additional dropout
...
history_file = 'training_history_vit.csv'
output_dir = "Potato_Model_Output_ViT"
os.makedirs(output_dir, exist_ok=True)
history_file_path = os.path.join(output_dir, history_file)
checkpoint_path = os.path.join(output_dir, 'checkpoint_vit.pt')
...
try:
    ...
    print(history_df[['Epoch', 'Train Accuracy']])
except Exception as e:
    print(f"Error reading training history CSV: {e}")
    raise